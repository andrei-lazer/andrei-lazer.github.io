...
This is a price-time priority matching engine written in <span
style="white-space:nowrap;">C++</span>. I implemented basic functionality for Good-Till-Cancel limit
...
from 2011, especially the use of ordered maps for storing limits,
and a lock-free ring buffer for updating external observers.

It's quite a small project, but it took me a good amount of effort due to my relative lack of
experience with C++ at the time. This is the project which best represents my <span
style="white-space:nowrap;">C++</span> skills.
