...
I use [Neovim](https://neovim.io/) by the way, and I wanted to write a post about why I use it.
...
Also, Neovim (can) very nicely follow the [Unix philosphy](https://en.wikipedia.org/wiki/Unix_philosophy).
...
- Miscllaneous videos
    - [New native lsp runthrough](https://www.youtube.com/watch?v=HLp879ZDhVc&pp=ygUGbmVvdmlt)
